...
ball.style.backgroundImage = "url('../static/Images/ball.png')";
...
paddle.style.backgroundImage = "url('../static/Images/brickBreacker_Paddle.png')";
paddle.style.backgroundSize = "100px 20px"
    ...
    for (let tBrick of bricks) {
        if (isCollide(tBrick, ball)) {
            ...
            switch(tBrick.id)
            {
                case "hard":
                    tBrick.id = "med";
                    tBrick.style.backgroundColor= "Orange";
                    break;
                case "med":
                    tBrick.id = "low";
                    tBrick.style.backgroundColor = "Blue"
                    break;
                case "low":
                    tBrick.parentNode.removeChild(tBrick);
                    player.score++;
